...
| OpenServiceMesh.featureFlags.enableEgressPolicy | bool | `false` | Enable OSM's Egress policy API. If specified, fine grained control over Egress (external) traffic is enforced |
